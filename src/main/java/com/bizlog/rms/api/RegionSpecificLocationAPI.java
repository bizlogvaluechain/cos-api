...
public interface RegionSpecificLocationAPI extends BaseAPI<RegionSpecificLocationDTO,RegionSpecificLocationDTO> {
    @PostMapping
    ResponseEntity<RegionSpecificLocationDTO> create(Long clientId, RegionSpecificLocationDTO regionSpecificLocationDTO);
    ...
    @PutMapping("/{id}")
    ResponseEntity<RegionSpecificLocationDTO> update(Long Id, Long id, RegionSpecificLocationDTO regionSpecificLocationDTO);
