...
public interface OperationContactAPI extends BaseAPI<OperationContactInformationDTO, OperationContactInformationDTO> {
    ...
    @PostMapping
    ResponseEntity<List<OperationContactInformationDTO>> create(Long clientId,
            List<OperationContactInformationDTO> inputDTO);
    ...
    @PutMapping("/{id}")
    ResponseEntity<OperationContactInformationDTO> update(Long clientId, Long id,
            OperationContactInformationDTO inputDTO);
