...
public interface TATAPI extends BaseAPI<TATDTO, TATDTO> {
    @PostMapping
    ResponseEntity<TATDTO> create(@PathVariable("clientId") Long clientId, @RequestBody TATDTO tatdto);
    ...
    @PutMapping("/{id}")
    ResponseEntity<TATDTO> update(@PathVariable("clientId") Long clientId, @PathVariable("id") Long id, TATDTO tatdto);
