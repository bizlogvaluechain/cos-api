...
public class FinanceContactInformationResource extends
    ...
    public ResponseEntity<List<AuditLogsDTO>> getAllAudits(Pageable pageable) {
        ...
        return super.getAllAudits(FinanceContactInformation.class,pageable);
    }

    @Override
    @Transactional
    public ResponseEntity<List<AuditLogsDTO>> getAllAuditsWithId(Pageable pageable, Long id) {
        return super.getAllAuditsWithId(FinanceContactInformation.class,pageable,id);
    }

    @Override
    @Transactional
    public ResponseEntity<List<AuditLogsDTO>> getAllAuditsByDate(Pageable pageable, Date startDate, Date endDate) {
        return super.getAllAuditsByDate(FinanceContactInformation.class,pageable,startDate,endDate);
    }

    @Override
    @Transactional
    public ResponseEntity<List<AuditLogsDTO>> getAllAuditsByDateWithId(Pageable pageable, Date startDate, Date endDate, Long id) {
        return super.getAllAuditsByDateWithId(FinanceContactInformation.class,pageable,startDate,endDate,id);
    }
}
