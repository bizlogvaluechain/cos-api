...
public class ClientTechEscalationResource
    ...
    @Override
    public ResponseEntity<ClientTechEscalationDTO> getById(Long clientId, Long id) {
        return super.get(clientId, id);
    }

    @Override
    public ResponseEntity<PageResponse<ClientTechEscalationDTO>> getAll(Long clientId, Pageable pageable) {
        return super.getAllConfig(clientId, pageable);
    }

    @Override
    public ResponseEntity<PageResponse<ClientTechEscalationDTO>> search(Long clientId,
