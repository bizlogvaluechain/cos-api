...
//    }
    @Override
    public ResponseEntity<PageResponse<EscalationMatrixDTO>> search(@PathVariable Long clientId, @RequestParam Map<String, String> searchCriteria, @RequestParam Optional<Set<String>> attributesOpt, Pageable pageable) {
