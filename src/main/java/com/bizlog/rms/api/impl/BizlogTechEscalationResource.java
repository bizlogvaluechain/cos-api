...
public class BizlogTechEscalationResource
    ...
    @Override
    public ResponseEntity<BizlogTechEscalationDTO> getById(@PathVariable("clientId")Long clientId,@PathVariable("id") Long id) {
        return super.get(clientId, id);
    }

    @Override
    public ResponseEntity<PageResponse<BizlogTechEscalationDTO>> getAll(@PathVariable("clientId")Long clientId, Pageable pageable) {
