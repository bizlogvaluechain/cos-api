...
public class ClientOpsEscalationResource
    ...
    @Override
    public ResponseEntity<ClientOpsEscalationDTO> getById(Long clientId, Long id) {
        return super.get(clientId, id);
    }

    @Override
    public ResponseEntity<PageResponse<ClientOpsEscalationDTO>> getAll(Long clientId, Pageable pageable) {
        return super.getAllConfig(clientId, pageable);
    }

    @Override
    public ResponseEntity<PageResponse<ClientOpsEscalationDTO>> search(Long clientId,
