...
public interface TATActivityAPI extends BaseAPI<TATActivityDTO, TATActivityDTO> {
    @PostMapping
    ResponseEntity<TATActivityDTO> create(@PathVariable("clientId") Long clientId, @RequestBody TATActivityDTO tatActivityDTO);
    ...
    @PutMapping("/{id}")
    ResponseEntity<TATActivityDTO> update(@PathVariable("clientId") Long clientId,@PathVariable("id") Long id, TATActivityDTO tatActivityDTO);
