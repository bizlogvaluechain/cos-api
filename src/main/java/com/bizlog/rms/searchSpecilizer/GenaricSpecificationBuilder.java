...
public class GenaricSpecificationBuilder<T extends BaseClientEntity> {
    ...
    public final GenaricSpecificationBuilder with(String key,
                                              String operation, Object value){
        params.add(new SearchCriteria(key, operation, value));
        return this;
    }

    public final GenaricSpecificationBuilder with(SearchCriteria
                                                      searchCriteria){
    ...
    public Specification<T> build(){
        ...
        Specification<T> result =
                new ClientProfileSpecification(params.get(0));
        for (int idx = 1; idx < params.size(); idx++){
            ...
            result =  SearchOperation.getDataOption(criteria
                    ...
                    ClientProfileSpecification(criteria))
                    : Specification.where(result).or(
                    new ClientProfileSpecification(criteria));
        }
        return result;
    }
}
